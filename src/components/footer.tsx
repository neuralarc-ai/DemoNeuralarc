...
const Footer = () => {
  return (
    <footer className="mx-auto shadow-[0_-8px_0_0_#757372] bg-[#1E1E1E] rounded-t-2xl ">
      <div className="lg:h-[264px] max-w-[1920px] bg-[#1E1E1E] rounded-t-3xl flex flex-col justify-between mx-auto w-full text-white lg:py-10 py-5 lg:px-10 px-4 z-50">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 text-[#E6E6E6] text-sm">
          <div className="flex flex-wrap gap-2 lg:gap-4 justify-center items-center lg:justify-start">
            <Link href="/terms-of-use" className="hover:underline hover:text-white transition-all duration-300 font-light lg:text-base text-sm text-[#AFAFAF]">
              Terms of use
            </Link>
            <span className="hidden lg:inline text-[#313534] text-2xl">•</span>
            <Link href="/privacy-policy" className="hover:underline hover:text-white transition-all duration-300 font-light lg:text-base text-sm text-[#AFAFAF]">
              Privacy Policy
            </Link>
            <span className="hidden text-[#313534] text-2xl lg:inline">•</span>
            <Link href="/disclaimer" className="hover:underline hover:text-white transition-all duration-300 font-light lg:text-base text-sm text-[#AFAFAF]">
              Disclaimer
            </Link>
            <span className="hidden lg:inline text-[#313534] text-2xl">•</span>
            <Link href="/responsible-ai" className="hover:underline hover:text-white transition-all duration-300 font-light lg:text-base text-sm text-[#AFAFAF]">
              Responsible & Ethical AI
            </Link>
          </div>
          <div className="flex items-center gap-2 mt-2 lg:mt-0">
            <span>All rights reserved. A thing by</span>
            <span>
              <Image
                src="/logo.png"
                alt="NeuralArc Logo"
